<template>
  <div id="contact">
    ...
    <div id="wen4">
      ...
      <span
        >ps:非新思路统招只有通过发送邮件自我介绍后，收到邮件回执后才会被允许进群,在读学生,都可邮件到newthread-geek@outlook.com报名加入.(信中需备注个人基本信息以及意向方向,此招新活动为长期招新)</span
      >
    </div>
    ...
    <div id="wayofcontact">
      <button
        id="cf4"
        target="_blank"
        onclick="window.location.href='https://qm.qq.com/cgi-bin/qm/qr?k=_MXIavH-bKiRMl5LvZHVKnIjjhuHDNGC&jump_from=webapi'"
        alt="Geek组迎新群"
        title="群号:60587286"
        class="q"
      >
      ...
      <button
        id="cf5"
        onclick="window.location.href='https://github.com/ntgeek'"
        TITLE="Geek组Github"
        class="q"
      >
        Github
      ...
      <button
        v-on:click="bn1()"
        title="newthread-geek@outlook.com"
        id="yx"
        class="q"
      >
        E-mail
